...
{
    public partial class MzHjFast_gh : Form
    {
        ...
        public MzHjFast_gh(LoginModel loginModel)
        {
            this.loginModel = loginModel;
            InitializeComponent();
            FormHelper.initForm(this);
            SkinButtonHelper.initButton(this.skinButton_病人查询, this.skinButton_save);
        ...
        private void MzHjFast_gh_Load(object sender, EventArgs e)
        {
            try
            {
                this.initUI();
        ...
        private void skinButton_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool flag = mzBll.saveGhForShouFei(jmSave, ghSave);
                if (flag)
                {
