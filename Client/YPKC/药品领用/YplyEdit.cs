...
{
    public partial class YplyEdit : Form
    {
        ...
        public YplyEdit(Jc_renyuan workRenyuan, Jc_code djLx, Jc_code ypLx)
        {
        ...
        public YplyEdit(Ypkc_dj oldDj, Jc_renyuan workRenyuan)
        {
            this.oldDj = oldDj;
        ...
        private void initUI()
        {
          ...
          //初始化有药房标志和药库标志的科室
            ...
            ComboBoxHelper.initComboBoxForKswh(skinComboBox_目的科室, null, CommonCode.代码值_作废标志代码值.启用);
            ...
            if (this.oldDj != null)//修改，以及记账
            {
                ...
                skinComboBox_来源科室.SelectedIndex = ComboBoxHelper.getComboBoxIndexByValue(skinComboBox_来源科室, this.oldDj.Fk_lyks, CommonCode.实体类名称.基础_供应商实体类名);
                skinComboBox_目的科室.SelectedIndex = ComboBoxHelper.getComboBoxIndexByValue(skinComboBox_目的科室, this.oldDj.Fk_mdks, CommonCode.实体类名称.基础_科室实体类名);               
        ...
        private void YplyEdit_Load(object sender, EventArgs e)
        {
            try
            {
            }
