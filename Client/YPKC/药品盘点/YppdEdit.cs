...
{
    public partial class YppdEdit : Form
    {
        ...
        public YppdEdit(Jc_renyuan workRenyuan, Jc_code djLx, Jc_code ypLx)
        {
        ...
        public YppdEdit(Ypkc_dj oldDj, Jc_renyuan workRenyuan)
        {
            this.oldDj = oldDj;
        ...
        private void initUI()
        {
            ...
            //初始化有药房标志和药库标志的科室
            ComboBoxHelper.initComboBoxForKswh_YfYk(skinComboBox_收货科室);
        ...
        private void YppdEdit_Load(object sender, EventArgs e)
        {
            try
            {
            }
