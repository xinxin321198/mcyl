...
{
    public partial class YpKuCunSearchForYz : Form
    {
        ...
        /// </summary>
        /// <param name="ks"></param>
        public YpKuCunSearchForYz(Jc_kswh ks)
        {
        ...
        private void initDataGridView(string ss)
        {
            ...
            List<object> objs = ypkcBll.getListByPageForYzFast(kcParam, this.page, kcParamLike, null);
