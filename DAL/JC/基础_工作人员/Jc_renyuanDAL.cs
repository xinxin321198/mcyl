...
namespace DAL.JC.基础_工作人员
{
    ...
    /// </summary>
    public interface Jc_renyuanDAL
    {
        ...
        bool deleteByOtherCondition(Jc_renyuan jc_renyuanParamCondition , OracleConnection con);
        ...
        /// <param name="jc_renyuanParam">要修改的jc_renyuanParam对象</param>
        /// <param name="con">Oracle连接对象（为null时自动生成）</param>
        /// <returns>是否修改成功（影响的行数为1时成功）</returns>
        bool updateById(Jc_renyuan jc_renyuanParam,OracleConnection con);

        /// <summary>
        /// 根据codeList中的ID修改多条数据（如果需要供事务使用就传入OracleConnection对象，如果不供就传入null，方法自动生成OracleConnection对象）
        /// </summary>
        /// <param name=jc_renyuanParamList">要修改的jc_renyuanParamList对象集合</param>
        /// <param name="con">Oracle连接对象（为null时自动生成）</param>
        /// <returns>是否删除成功（影响的行数等于要修改的对象数量时成功）</returns>
        bool updateByIdBatch(List<Jc_renyuan> jc_renyuanParamList, OracleConnection con);
        ...
        bool updateByOtherCondition(Jc_renyuan jc_renyuanParamCondition, Jc_renyuan jc_renyuanParamUpdate, OracleConnection con);
        ...
        List<object> find(Jc_renyuan jc_renyuanParam, Model.Common.PageInfo page,Jc_renyuan jc_renyuanParamLike,List<SortInfo> sortList);
        ...
        int getCount(Jc_renyuan jc_renyuanParam,Jc_renyuan jc_renyuanParamLike);

        /// <summary>
        /// 通用的保存方法，可新增或修改，根据用户传入的参数，有ID为修改，没有ID为新增(手动生成OracleConnection对象，此方法用于事务，使用事务必须使用同一个OracleConnection对象)
        /// </summary>
        /// <param name="jc_renyuanParam">要保存或更新的Jc_renyuan对象</param>
        /// <returns>bool，保存是否成功</returns>
        bool save(Jc_renyuan jc_renyuanParam,OracleConnection con);
        ...
        /// <returns>Jc_renyuan</returns>
        Jc_renyuan findContactObjectsById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>满足条件的所有Jc_renyuan对象集合list</returns>
        List<object> findContactObjects(Jc_renyuan jc_renyuanParam, Model.Common.PageInfo page, Jc_renyuan jc_renyuanParamLike, List<SortInfo> sortList);
