...
namespace DAL.Common
{
    ...
    /// 不允许实例化，在应用时直接调用即可
    /// </summary>
    public abstract class SqlHelper_sufei
    {
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
        public static readonly string connectionString = Model.Common.AppConfigHelper.GetConnectionStringsConfig("sqlServerConnection");//从配置文件中读取数据库连接字符串
        ...
        {
            return GetTable(SqlHelper_sufei.connectionString, cmdTye, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlHelper_sufei.connectionString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlHelper_sufei.connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(SqlHelper_sufei.connectionString, CommandType.Text, cmdText, commandParameters);
        }
