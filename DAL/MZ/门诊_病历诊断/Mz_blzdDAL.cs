...
namespace DAL.MZ.门诊_病历诊断
{
    ...
    public interface Mz_blzdDAL
    {
        ...
        bool deleteByOtherCondition(Mz_blzd mz_blzdParamCondition , OracleConnection con);
        ...
        /// <param name="mz_blzdParam">要修改的mz_blzdParam对象</param>
        /// <param name="con">Oracle连接对象（为null时自动生成）</param>
        /// <returns>是否修改成功（影响的行数为1时成功）</returns>
        bool updateById(Mz_blzd mz_blzdParam,OracleConnection con);

        /// <summary>
        /// 根据codeList中的ID修改多条数据（如果需要供事务使用就传入OracleConnection对象，如果不供就传入null，方法自动生成OracleConnection对象）
        /// </summary>
        /// <param name=mz_blzdParamList">要修改的mz_blzdParamList对象集合</param>
        /// <param name="con">Oracle连接对象（为null时自动生成）</param>
        /// <returns>是否删除成功（影响的行数等于要修改的对象数量时成功）</returns>
        bool updateByIdBatch(List<Mz_blzd> mz_blzdParamList, OracleConnection con);
        ...
        bool updateByOtherCondition(Mz_blzd mz_blzdParamCondition, Mz_blzd mz_blzdParamUpdate, OracleConnection con);
        ...
        List<object> find(Mz_blzd mz_blzdParam, Model.Common.PageInfo page,Mz_blzd mz_blzdParamLike,List<SortInfo> sortList);
        ...
        int getCount(Mz_blzd mz_blzdParam,Mz_blzd mz_blzdParamLike);

        /// <summary>
        /// 通用的保存方法，可新增或修改，根据用户传入的参数，有ID为修改，没有ID为新增(手动生成OracleConnection对象，此方法用于事务，使用事务必须使用同一个OracleConnection对象)
        /// </summary>
        /// <param name="mz_blzdParam">要保存或更新的Mz_blzd对象</param>
        /// <returns>bool，保存是否成功</returns>
        bool save(Mz_blzd mz_blzdParam,OracleConnection con);
