...
namespace BLL.JC.基础_药品字典
{
    ...
    public interface Jc_ypBLL
    {
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_yp> jc_ypParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_yp> jc_ypParamList);
        ...
        List<object> getList(Jc_yp jc_ypParam,Jc_yp jc_ypParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_yp jc_ypParam, Model.Common.PageInfo page,Jc_yp jc_ypParamLike,List<SortInfo> sortList);
        ...
        Jc_yp getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_yp jc_ypParam, Jc_yp jc_ypParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_yp jc_ypParam, Model.Common.PageInfo page, Jc_yp jc_ypParamLike, List<SortInfo> sortList);

        /// <summary>
        /// （快速查询，只有必要字段，以及like中文时同时查药品名及通用名，查药品编号从开头匹配）得到所有关联对象，带分页参数，给分页参数指定pagesize得到第一页的数据或者不指定分页参数，系统使用默认的pagesize值
        /// 第一个参数是查询参数，如果查询参数为null则查询所有
        /// 第二个参数是分页参数，如果page参数为null,方法则会new一个默认的page，根据page中的pagesize参数查询出相应的条数
        /// 第三个参数是模糊查询参数，提供模糊查询功能，只适用于string类型的字段
        /// 第四个参数是排序的参数，传入排序的对象的集合，如果传null，则默认使用ID字段进行排序
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPageForFast(Jc_yp jc_ypParam, Model.Common.PageInfo page, Jc_yp jc_ypParamLike, List<SortInfo> sortList);
