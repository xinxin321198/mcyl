...
namespace BLL.JC.基础_诊疗项目管理
{
    ...
    public interface Jc_zlxmBLL
    {
        ...
        bool save(Jc_zlxm jc_zlxmParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_zlxm> jc_zlxmParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_zlxm> jc_zlxmParamList);
        ...
        List<object> getList(Jc_zlxm jc_zlxmParam,Jc_zlxm jc_zlxmParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_zlxm jc_zlxmParam, Model.Common.PageInfo page,Jc_zlxm jc_zlxmParamLike,List<SortInfo> sortList);
        ...
        Jc_zlxm getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_zlxm jc_zlxmParam, Jc_zlxm jc_zlxmParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_zlxm jc_zlxmParam, Model.Common.PageInfo page, Jc_zlxm jc_zlxmParamLike, List<SortInfo> sortList);
