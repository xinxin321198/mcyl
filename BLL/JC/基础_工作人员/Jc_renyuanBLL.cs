...
namespace BLL.JC.基础_工作人员
{
     ...
     */
    /// </summary>
    public interface Jc_renyuanBLL
    {
        ...
        bool save(Jc_renyuan jc_renyuanParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_renyuan> jc_renyuanParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_renyuan> jc_renyuanParamList);
        ...
        List<object> getList(Jc_renyuan jc_renyuanParam,Jc_renyuan jc_renyuanParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_renyuan jc_renyuanParam, Model.Common.PageInfo page,Jc_renyuan jc_renyuanParamLike,List<SortInfo> sortList);
        ...
        Jc_renyuan getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_renyuan jc_renyuanParam, Jc_renyuan jc_renyuanParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_renyuan jc_renyuanParam, Model.Common.PageInfo page, Jc_renyuan jc_renyuanParamLike, List<SortInfo> sortList);
