...
namespace BLL.JC.基础_ICD10
{
    ...
    public interface Jc_icd10BLL
    {
        ...
        bool save(Jc_icd10 jc_icd10Param);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_icd10> jc_icd10ParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_icd10> jc_icd10ParamList);
        ...
        List<object> getList(Jc_icd10 jc_icd10Param,Jc_icd10 jc_icd10ParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_icd10 jc_icd10Param, Model.Common.PageInfo page,Jc_icd10 jc_icd10ParamLike,List<SortInfo> sortList);
