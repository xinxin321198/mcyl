...
namespace BLL.JC.基础_居民
{
    ...
    public interface Jc_jmBLL
    {
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_jm> jc_jmParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_jm> jc_jmParamList);
        ...
        List<object> getList(Jc_jm jc_jmParam,Jc_jm jc_jmParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_jm jc_jmParam, Model.Common.PageInfo page,Jc_jm jc_jmParamLike,List<SortInfo> sortList);
        ...
        Jc_jm getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_jm jc_jmParam, Jc_jm jc_jmParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_jm jc_jmParam, Model.Common.PageInfo page, Jc_jm jc_jmParamLike, List<SortInfo> sortList);
