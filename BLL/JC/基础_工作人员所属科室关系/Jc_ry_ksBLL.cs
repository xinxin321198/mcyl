...
namespace BLL.JC.基础_工作人员所属科室关系
{
    ...
    public interface Jc_ry_ksBLL
    {
        ...
        bool save(Jc_ry_ks jc_ry_ksParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_ry_ks> jc_ry_ksParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_ry_ks> jc_ry_ksParamList);
        ...
        List<object> getList(Jc_ry_ks jc_ry_ksParam,Jc_ry_ks jc_ry_ksParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_ry_ks jc_ry_ksParam, Model.Common.PageInfo page,Jc_ry_ks jc_ry_ksParamLike,List<SortInfo> sortList);
        ...
        Jc_ry_ks getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_ry_ks jc_ry_ksParam, Jc_ry_ks jc_ry_ksParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_ry_ks jc_ry_ksParam, Model.Common.PageInfo page, Jc_ry_ks jc_ry_ksParamLike, List<SortInfo> sortList);
