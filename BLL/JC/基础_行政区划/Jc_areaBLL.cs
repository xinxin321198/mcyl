...
namespace BLL.JC.基础_行政区划
{
    ...
    public interface Jc_areaBLL
    {
        ...
        bool save(Jc_area jc_areaParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_area> jc_areaParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_area> jc_areaParamList);
        ...
        List<object> getList(Jc_area jc_areaParam,Jc_area jc_areaParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_area jc_areaParam, Model.Common.PageInfo page,Jc_area jc_areaParamLike,List<SortInfo> sortList);
        ...
        Jc_area getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_area jc_areaParam, Jc_area jc_areaParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_area jc_areaParam, Model.Common.PageInfo page, Jc_area jc_areaParamLike, List<SortInfo> sortList);
