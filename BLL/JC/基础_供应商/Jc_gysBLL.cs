...
namespace BLL.JC.基础_供应商
{
    ...
    public interface Jc_gysBLL
    {
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_gys> jc_gysParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_gys> jc_gysParamList);
        ...
        List<object> getList(Jc_gys jc_gysParam,Jc_gys jc_gysParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_gys jc_gysParam, Model.Common.PageInfo page,Jc_gys jc_gysParamLike,List<SortInfo> sortList);
        ...
        Jc_gys getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_gys jc_gysParam, Jc_gys jc_gysParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_gys jc_gysParam, Model.Common.PageInfo page, Jc_gys jc_gysParamLike, List<SortInfo> sortList);
