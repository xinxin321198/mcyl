...
namespace BLL.JC.基础_工作人员账户关系表
{
     ...
     */
    /// </summary>
    public interface Jc_renyuan_userBLL
    {
        ...
        bool save(Jc_renyuan_user jc_renyuan_userParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_renyuan_user> jc_renyuan_userParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_renyuan_user> jc_renyuan_userParamList);
        ...
        List<object> getList(Jc_renyuan_user jc_renyuan_userParam,Jc_renyuan_user jc_renyuan_userParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_renyuan_user jc_renyuan_userParam, Model.Common.PageInfo page,Jc_renyuan_user jc_renyuan_userParamLike,List<SortInfo> sortList);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Jc_renyuan_user getById(string id);
        ...
        Jc_renyuan_user getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_renyuan_user jc_renyuan_userParam, Jc_renyuan_user jc_renyuan_userParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_renyuan_user jc_renyuan_userParam, Model.Common.PageInfo page, Jc_renyuan_user jc_renyuan_userParamLike, List<SortInfo> sortList);
