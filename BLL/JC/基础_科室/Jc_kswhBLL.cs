...
namespace BLL.JC.基础_科室
{
    ...
    public interface Jc_kswhBLL
    {
        ...
        bool save(Jc_kswh jc_kswhParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_kswh> jc_kswhParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_kswh> jc_kswhParamList);
        ...
        List<object> getList(Jc_kswh jc_kswhParam,Jc_kswh jc_kswhParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_kswh jc_kswhParam, Model.Common.PageInfo page,Jc_kswh jc_kswhParamLike,List<SortInfo> sortList);
        ...
        Jc_kswh getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_kswh jc_kswhParam, Jc_kswh jc_kswhParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_kswh jc_kswhParam, Model.Common.PageInfo page, Jc_kswh jc_kswhParamLike, List<SortInfo> sortList);
        ...
        /// <summary>
        /// 删除此科室关联的记录(目前有人员科室关系记录表)
        /// </summary>
        /// <param Name="jc_renyuanParam"></param>
        /// <returns></returns>
        bool deleteContactRecord(Jc_kswh jc_kswhParam);

        /// <summary>
        /// 根据人员的ID，得到此人员所属的科室集合
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        List<Jc_kswh> getKeshiListByRenyuanId(string renyuanId);
