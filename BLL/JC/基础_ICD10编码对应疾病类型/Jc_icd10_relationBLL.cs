...
namespace BLL.JC.基础_ICD10编码对应疾病类型
{
     ...
     */
    /// </summary>
    public interface Jc_icd10_relationBLL
    {
        ...
        bool save(Jc_icd10_relation jc_icd10_relationParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_icd10_relation> jc_icd10_relationParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_icd10_relation> jc_icd10_relationParamList);
        ...
        List<object> getList(Jc_icd10_relation jc_icd10_relationParam,Jc_icd10_relation jc_icd10_relationParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_icd10_relation jc_icd10_relationParam, Model.Common.PageInfo page,Jc_icd10_relation jc_icd10_relationParamLike,List<SortInfo> sortList);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Jc_icd10_relation getById(string id);
        ...
        Jc_icd10_relation getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Jc_icd10_relation jc_icd10_relationParam, Jc_icd10_relation jc_icd10_relationParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Jc_icd10_relation jc_icd10_relationParam, Model.Common.PageInfo page, Jc_icd10_relation jc_icd10_relationParamLike, List<SortInfo> sortList);
