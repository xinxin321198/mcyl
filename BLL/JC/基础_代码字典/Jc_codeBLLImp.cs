...
namespace BLL.JC.基础_代码字典
{
     ...
     */
    /// </summary>
    public class Jc_codeBLLImp:Jc_codeBLL
    {
        ...
        public bool save(Jc_code jc_codeParam)
        {
            return jc_codeDal.save(jc_codeParam,null);
        }
        ...
        /// <returns>bool,是否成功</returns>
        public bool inertList(List<Jc_code> jc_codeParamList)
        {
            return jc_codeDal.inertBatch(jc_codeParamList,null);
        }
        ...
        {
            return jc_codeDal.deleteById(id,null);
        }
        ...
        {
            return jc_codeDal.deleteByIdBatch(idList,null);
        }
        ...
        /// <returns>bool,是否成功</returns>
        public bool updateByIdList(List<Jc_code> jc_codeParamList)
        {
            return jc_codeDal.updateByIdBatch(jc_codeParamList, null);
        }
        ...
        public List<object> getList(Jc_code jc_codeParam,Jc_code jc_codeParamLike,List<SortInfo> sortList)
        {
            return jc_codeDal.find(jc_codeParam, null,jc_codeParamLike,sortList);
        }
        ...
        ///<param name="jc_codeParamLike">模糊查询参数</param>
        ///<param name="sortList">排序参数对象的集合</param>
        public List<object> getListByPage(Jc_code jc_codeParam, Model.Common.PageInfo page,Jc_code jc_codeParamLike,List<SortInfo> sortList)
        {
            //如果没有传分页对象，构建一个对应的分页对象（重点是必须给AllCount属性赋值）
            if (null==page)
            {
                page = new Model.Common.PageInfo();
                page.AllCount = jc_codeDal.getCount(jc_codeParam, jc_codeParamLike);
            }
            return jc_codeDal.find(jc_codeParam, page,jc_codeParamLike,sortList);
        ...
        public Jc_code getById(string id)
        {
            return jc_codeDal.findById(id);
        }
        ...
        {
            return jc_codeDal.getCount(jc_codeParam,jc_codeParamLike);
        }
        //*******************在此以后添加新的方法start
        ...
        public Jc_code getContactObjectById(string id)
        {
            return jc_codeDal.findContactObjectsById(id);
        }
        ...
        public List<object> getListContactObject(Jc_code jc_codeParam, Jc_code jc_codeParamLike, List<SortInfo> sortList)
        {
            return jc_codeDal.findContactObjects(jc_codeParam, null, jc_codeParamLike, sortList);
        }
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        public List<object> getListContactObjectByPage(Jc_code jc_codeParam, Model.Common.PageInfo page, Jc_code jc_codeParamLike, List<SortInfo> sortList)
        {
            if (null == page)
            {
                page = new Model.Common.PageInfo();
            ...
            return jc_codeDal.findContactObjects(jc_codeParam, page, jc_codeParamLike, sortList);
        }
