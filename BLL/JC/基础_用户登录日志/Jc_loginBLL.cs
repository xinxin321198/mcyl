...
namespace BLL.JC.基础_用户登录日志
{
    ...
    public interface Jc_loginBLL
    {
        ...
        bool save(Jc_login jc_loginParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_login> jc_loginParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_login> jc_loginParamList);
        ...
        List<object> getList(Jc_login jc_loginParam,Jc_login jc_loginParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_login jc_loginParam, Model.Common.PageInfo page,Jc_login jc_loginParamLike,List<SortInfo> sortList);
