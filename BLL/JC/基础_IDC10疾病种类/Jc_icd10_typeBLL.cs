...
namespace BLL.JC.基础_IDC10疾病种类
{
     ...
     */
    /// </summary>
    public interface Jc_icd10_typeBLL
    {
        ...
        bool save(Jc_icd10_type jc_icd10_typeParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Jc_icd10_type> jc_icd10_typeParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Jc_icd10_type> jc_icd10_typeParamList);
        ...
        List<object> getList(Jc_icd10_type jc_icd10_typeParam,Jc_icd10_type jc_icd10_typeParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Jc_icd10_type jc_icd10_typeParam, Model.Common.PageInfo page,Jc_icd10_type jc_icd10_typeParamLike,List<SortInfo> sortList);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Jc_icd10_type getById(string id);
