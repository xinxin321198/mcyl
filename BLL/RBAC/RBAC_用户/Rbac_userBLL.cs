...
namespace BLL.RBAC.RBAC_用户
{
    ...
    public interface Rbac_userBLL
    {
        ...
        bool save(Rbac_user rbac_userParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Rbac_user> rbac_userParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Rbac_user> rbac_userParamList);
        ...
        List<object> getList(Rbac_user rbac_userParam,Rbac_user rbac_userParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Rbac_user rbac_userParam, Model.Common.PageInfo page,Rbac_user rbac_userParamLike,List<SortInfo> sortList);
        ...
        Rbac_user getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Rbac_user rbac_userParam, Rbac_user rbac_userParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Rbac_user rbac_userParam, Model.Common.PageInfo page, Rbac_user rbac_userParamLike, List<SortInfo> sortList);
