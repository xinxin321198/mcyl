...
namespace BLL.RBAC.RBAC_角色模块关系
{
     ...
     */
    /// </summary>
    public interface Rbac_role_modulesBLL
    {
        ...
        bool save(Rbac_role_modules rbac_role_modulesParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Rbac_role_modules> rbac_role_modulesParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Rbac_role_modules> rbac_role_modulesParamList);
        ...
        List<object> getList(Rbac_role_modules rbac_role_modulesParam,Rbac_role_modules rbac_role_modulesParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Rbac_role_modules rbac_role_modulesParam, Model.Common.PageInfo page,Rbac_role_modules rbac_role_modulesParamLike,List<SortInfo> sortList);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Rbac_role_modules getById(string id);
        ...
        Rbac_role_modules getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Rbac_role_modules rbac_role_modulesParam, Rbac_role_modules rbac_role_modulesParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Rbac_role_modules rbac_role_modulesParam, Model.Common.PageInfo page, Rbac_role_modules rbac_role_modulesParamLike, List<SortInfo> sortList);
