...
namespace BLL.RBAC.RBAC_角色
{
    ...
    public interface Rbac_roleBLL
    {
        ...
        bool save(Rbac_role rbac_roleParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Rbac_role> rbac_roleParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Rbac_role> rbac_roleParamList);
        ...
        List<object> getList(Rbac_role rbac_roleParam,Rbac_role rbac_roleParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Rbac_role rbac_roleParam, Model.Common.PageInfo page,Rbac_role rbac_roleParamLike,List<SortInfo> sortList);
