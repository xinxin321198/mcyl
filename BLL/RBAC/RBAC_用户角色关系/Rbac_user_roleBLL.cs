...
namespace BLL.RBAC.RBAC_用户角色关系表
{
     ...
     */
    /// </summary>
    public interface Rbac_user_roleBLL
    {
        ...
        bool save(Rbac_user_role rbac_user_roleParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Rbac_user_role> rbac_user_roleParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Rbac_user_role> rbac_user_roleParamList);
        ...
        List<object> getList(Rbac_user_role rbac_user_roleParam,Rbac_user_role rbac_user_roleParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Rbac_user_role rbac_user_roleParam, Model.Common.PageInfo page,Rbac_user_role rbac_user_roleParamLike,List<SortInfo> sortList);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        Rbac_user_role getById(string id);
        ...
        Rbac_user_role getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Rbac_user_role rbac_user_roleParam, Rbac_user_role rbac_user_roleParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Rbac_user_role rbac_user_roleParam, Model.Common.PageInfo page, Rbac_user_role rbac_user_roleParamLike, List<SortInfo> sortList);
