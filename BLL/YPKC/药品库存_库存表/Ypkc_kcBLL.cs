...
namespace BLL.YPKC.药品库存_库存表
{
    ...
    public interface Ypkc_kcBLL
    {
        ...
        bool save(Ypkc_kc ypkc_kcParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Ypkc_kc> ypkc_kcParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Ypkc_kc> ypkc_kcParamList);
        ...
        List<object> getList(Ypkc_kc ypkc_kcParam,Ypkc_kc ypkc_kcParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Ypkc_kc ypkc_kcParam, Model.Common.PageInfo page,Ypkc_kc ypkc_kcParamLike,List<SortInfo> sortList);
        ...
        Ypkc_kc getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Ypkc_kc ypkc_kcParam, Ypkc_kc ypkc_kcParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Ypkc_kc ypkc_kcParam, Model.Common.PageInfo page, Ypkc_kc ypkc_kcParamLike, List<SortInfo> sortList);
