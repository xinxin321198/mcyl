...
namespace BLL.YPKC.药品库存_单据子表
{
    ...
    public interface Ypkc_djmxBLL
    {
        ...
        bool save(Ypkc_djmx ypkc_djmxParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Ypkc_djmx> ypkc_djmxParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Ypkc_djmx> ypkc_djmxParamList);
        ...
        List<object> getList(Ypkc_djmx ypkc_djmxParam,Ypkc_djmx ypkc_djmxParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Ypkc_djmx ypkc_djmxParam, Model.Common.PageInfo page,Ypkc_djmx ypkc_djmxParamLike,List<SortInfo> sortList);
