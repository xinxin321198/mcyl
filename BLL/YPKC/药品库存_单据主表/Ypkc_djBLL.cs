...
namespace BLL.YPKC.药品库存_单据主表
{
    ...
    public interface Ypkc_djBLL
    {
        ...
        bool save(Ypkc_dj ypkc_djParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Ypkc_dj> ypkc_djParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Ypkc_dj> ypkc_djParamList);
        ...
        List<object> getList(Ypkc_dj ypkc_djParam,Ypkc_dj ypkc_djParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Ypkc_dj ypkc_djParam, Model.Common.PageInfo page,Ypkc_dj ypkc_djParamLike,List<SortInfo> sortList);
        ...
        Ypkc_dj getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Ypkc_dj ypkc_djParam, Ypkc_dj ypkc_djParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Ypkc_dj ypkc_djParam, Model.Common.PageInfo page, Ypkc_dj ypkc_djParamLike, List<SortInfo> sortList);
