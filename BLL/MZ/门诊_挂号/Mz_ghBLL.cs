...
namespace BLL.MZ.门诊_挂号
{
    ...
    public interface Mz_ghBLL
    {
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Mz_gh> mz_ghParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Mz_gh> mz_ghParamList);
        ...
        List<object> getList(Mz_gh mz_ghParam,Mz_gh mz_ghParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Mz_gh mz_ghParam, Model.Common.PageInfo page,Mz_gh mz_ghParamLike,List<SortInfo> sortList);
        ...
        Mz_gh getContactObjectById(string id);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObject(Mz_gh mz_ghParam, Mz_gh mz_ghParamLike, List<SortInfo> sortList);
        ...
        ///<param name="sortList">排序参数对象的集合</param>
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListContactObjectByPage(Mz_gh mz_ghParam, Model.Common.PageInfo page, Mz_gh mz_ghParamLike, List<SortInfo> sortList);
