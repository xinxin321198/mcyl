...
namespace BLL.MZ.门诊_病历
{
    ...
    public interface Mz_blBLL
    {
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Mz_bl> mz_blParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Mz_bl> mz_blParamList);
        ...
        List<object> getList(Mz_bl mz_blParam,Mz_bl mz_blParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Mz_bl mz_blParam, Model.Common.PageInfo page,Mz_bl mz_blParamLike,List<SortInfo> sortList);
