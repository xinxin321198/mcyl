...
namespace BLL.MZ.门诊_病历诊断
{
    ...
    public interface Mz_blzdBLL
    {
        ...
        bool save(Mz_blzd mz_blzdParam);
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Mz_blzd> mz_blzdParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Mz_blzd> mz_blzdParamList);
        ...
        List<object> getList(Mz_blzd mz_blzdParam,Mz_blzd mz_blzdParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Mz_blzd mz_blzdParam, Model.Common.PageInfo page,Mz_blzd mz_blzdParamLike,List<SortInfo> sortList);
