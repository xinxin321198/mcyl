...
namespace BLL.MZ.门诊_医嘱
{
    ...
    public interface Mz_yzBLL
    {
        ...
        /// <returns>bool,是否成功</returns>
        bool inertList(List<Mz_yz> mz_yzParamList);
        ...
        /// <returns>bool,是否成功</returns>
        bool updateByIdList(List<Mz_yz> mz_yzParamList);
        ...
        List<object> getList(Mz_yz mz_yzParam,Mz_yz mz_yzParamLike,List<SortInfo> sortList);
        ...
        /// <returns>List<object>,索引0为数据，索引1为分页对象</returns>
        List<object> getListByPage(Mz_yz mz_yzParam, Model.Common.PageInfo page,Mz_yz mz_yzParamLike,List<SortInfo> sortList);
