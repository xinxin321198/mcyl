...
namespace BLL.MZ.门诊_医嘱
{
    /// <summary>
    ///业务逻辑层的实现类
    ///此类由代码生成器生成
    ///生成日期：2016-01-16 12:16:37
    /// 
     ...
     */
    /// </summary>
    public class Mz_yzBLLImp:Mz_yzBLL
    {
        private Mz_yzDAL mz_yzDal = new Mz_yzDALImp();
        
        /// <summary>
        /// 单条记录保存方法，有ID为修改，没有ID为新增
        /// </summary>
        /// <param name="mz_yzParam">保存的对象</param>
        /// <returns>bool,是否成功</returns>
        public bool save(Mz_yz mz_yzParam)
        {
            return mz_yzDal.save(mz_yzParam,null);
        }
        ...
        /// <returns>bool,是否成功</returns>
        public bool inertList(List<Mz_yz> mz_yzParamList)
        {
            return mz_yzDal.inertBatch(mz_yzParamList,null);
        }
        ...
        {
            return mz_yzDal.deleteById(id,null);
        }
        ...
        {
            return mz_yzDal.deleteByIdBatch(idList,null);
        }

        /// <summary>
        /// 批量修改（每个对象必须有ID）
        /// </summary>
        /// <param name="mz_yzParamList">要修改的数据集合</param>
        /// <returns>bool,是否成功</returns>
        public bool updateByIdList(List<Mz_yz> mz_yzParamList)
        {
            return mz_yzDal.updateByIdBatch(mz_yzParamList, null);
        }

        /// <summary>
        /// 根据参数条件，得到满足条件的MZ_YZ的所有对象列表
        /// 第一个参数是查询参数，如果查询参数为null则查询所有
        /// 第二个参数是模糊查询参数，提供模糊查询功能，只适用于string类型的字段
        /// 第三个参数是排序的参数，传入排序的对象的集合，如果传null，则默认使用ID字段进行排序
        /// </summary>
        /// <param name="mz_yzParam">查询参数</param>
        ///<param name="mz_yzParamLike">模糊查询参数</param>
        ///<param name="sortList">排序参数对象的集合</param>
        public List<object> getList(Mz_yz mz_yzParam,Mz_yz mz_yzParamLike,List<SortInfo> sortList)
        {
            return mz_yzDal.find(mz_yzParam, null,mz_yzParamLike,sortList);
        }

        /// <summary>
        /// 根据参数条件，得到满足条件的MZ_YZ的所有对象列表（使用分页的方式）
        /// 第一个参数是查询参数，如果查询参数为null则查询所有
        ...
        ///<param name="mz_yzParamLike">模糊查询参数</param>
        ///<param name="sortList">排序参数对象的集合</param>
        public List<object> getListByPage(Mz_yz mz_yzParam, Model.Common.PageInfo page,Mz_yz mz_yzParamLike,List<SortInfo> sortList)
        {
            //如果没有传分页对象，构建一个对应的分页对象（重点是必须给AllCount属性赋值）
            if (null==page)
            {
                page = new Model.Common.PageInfo();
                page.AllCount = mz_yzDal.getCount(mz_yzParam,mz_yzParamLike);
            }
            return mz_yzDal.find(mz_yzParam, page,mz_yzParamLike,sortList);
        ...
        public Mz_yz getById(string id)
        {
            return mz_yzDal.findById(id);
        }
        ...
        {
            return mz_yzDal.getCount(mz_yzParam,mz_yzParamLike);
        }
        //*******************在此以后添加新的方法start
